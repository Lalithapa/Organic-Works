...
document.querySelectorAll('.read-more-btn').forEach(function(btn) {
  btn.addEventListener('click', function() {
    var wrapper = this.parentNode.querySelector('.read-more-wrapper');
    this.parentNode.classList.toggle('marg-32');
...
class MenuDrawer extends HTMLElement {
  ...
  closeMenuDrawer(event, elementToFocus = false) {
    ...
    $('#filter-header-text').text("Filter and Sort");
    $('details.mobile-facets__details.js-filter').show();
    $('div.mobile-facets__details.js-filter').show();
